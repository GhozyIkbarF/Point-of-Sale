...
import { ShoppingCart, Money, Box, TrendCharts, Download } from '@element-plus/icons-vue';
...
const downloadPdf = () => {
    window.open(route('reports.export.pdf', { date: selectedDate.value }), '_blank');
};
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="space-y-6">
            <!-- Header -->
            <div>
                <h2 class="text-2xl font-semibold text-gray-800">Daily Sales Report</h2>
                <p class="mt-2 text-gray-600">Daily sales summary and analytics</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Hourly Transactions</h3>
                    <div class="space-y-2">
